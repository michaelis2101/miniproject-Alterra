...
class PlannerFromWish extends StatefulWidget {
  const PlannerFromWish({super.key});

  @override
  State<PlannerFromWish> createState() => _PlannerFromWish();
}

class _PlannerFromWish extends State<PlannerFromWish> {
  ...
  void initState() {
    ...
    setState(() {
      goalCont.text = wishData.itemname.toString();
      goalPriceCont.text = wishData.price.toString();
    });
  }
